...
<form method="post" class="" action="includes/add_values_to_jss.php">
    <div id="body">
                ...
                <center>     
                    ...
                    <span class="display-3 text-center" > ADD RESULTS JSS </span>
                 ...
                 <table class="table">
                    ...
                    <tr >
                     ...
                     <tr >
                        ...
                        <td><b>NO OF TIMES ABSENT: </b>  <br /><br> <input name="no_absent" type="text" value="" />
